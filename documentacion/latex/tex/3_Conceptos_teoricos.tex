...
\imagen{memoria/eeg}{Ejemplo colocación electrodos para una interfaz BCI.~\cite{egg:pixabay}}{.5}
...
\section{Conjunto de datos}
	...
	\imagen{memoria/Target}{Ejemplo conjunto de datos~\cite{dibujos:diagrams}}{.7}
...
\begin{itemize}
	...
	\imagen{anexos/Key}{Ejemplo valores de los datos target}{.7}
	...
	\imagen{memoria/Missing}{Ejemplo valores perdidos en un conjunto de datos}{.7}
...
Usando esta regla, se consideran outliers los datos que tienen un z-score mayor a 3 o menor a -3, ya que caen fuera del rango en el que se encuentra el 99.7 por ciento de los datos.
	...
	\imagen{memoria/Outliner}{Regla 68–95–99.7~\cite{outliners:empirica}}{.7}
...
Este proceso es muy beneficioso ya que asegura que todas las características contribuyan de manera equitativa al modelo y mejora la convergencia de algunos algoritmos de optimización.
	...
	\imagen{memoria/Scaler}{Ejemplo utilización StandardScaler()~\cite{Escaler:Standard}}{.7}
	...
	\imagen{memoria/Timestamp}{Datos Timestamp conjunto de datos}{.7}	
...
\imagen{memoria/particiones}{Ejemplo particiones del conjunto de datos~\cite{dibujos:diagrams}}{.7}
...
\section{Sobreajuste (overfitting)}
