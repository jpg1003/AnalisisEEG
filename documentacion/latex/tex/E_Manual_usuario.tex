...
\imagen{anexos/VirtualBox1}{Inicio instalación máquina virtual}


Pulsar en Terminar y espere que acabe la importación:


\imagen{anexos/VirtualBox2}{Importación máquina virtual}{.5}


Una vez importada, ya se puede arrancar con el botón en forma de flecha verde (Iniciar):


\imagen{anexos/VirtualBox3}{Arrancar máquina virtual}{.5}
